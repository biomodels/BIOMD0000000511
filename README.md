# BIOMD0000000511: MODEL1401070001
...
`pip install git+https://github.com/biomodels/BIOMD0000000511.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/BIOMD0000000511.git@20140916`

## Usage

Importing the model package.

`import BIOMD0000000511 as model`
...
and its subsequent utilizing reactions. This model correspond to Model D of
the paper.
...
and identified by:
[BIOMD0000000511](http://identifiers.org/biomodels.db/BIOMD0000000511) .
